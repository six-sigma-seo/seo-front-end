...
function desuso ({data}) {
  ...
  return (
    <Features>
      ...
      <Text>
        A lo largo de las versiónes de HTML han cambiado las etiquetas que componen al lenguaje y en la actualidad hay ciertas que se consideran en desuso, por lo que supone una buena practica sustituirlas
      </Text>
